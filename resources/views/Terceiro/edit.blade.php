   ...
   <div class="row">
    <div class="form-group col-md-8">   
     ...
     <div class="col-md-8">
      ...
      <input type="text" class="form-control" name="torneio"value="{{$finalista->torneio}}"></input> 
  ...
  <!-- <div class="form-group row"> -->
    <div class="form-group col-md-8"> 
      <div class="col-md-6">                                                <!-- juri : -->
        <label for="juri">Júri : 
          <input type="text" class="form-control" name="juri"value="{{$finalista->juri}}"></input>
        </label>
      </div>
    </div>  
    <div class="row"> 
      ...
      <div class="col-md-12">
        ...
        <div class="form-group col-md-12">
         <br> <label for="descricao" class="col-sm-2 col-form-label col-form-label-sm">Outros detalhes
          ...
          <br> <br><textarea name="descricao" rows="8" cols="80"value="{{$finalista->descricao}}"></textarea> 
        </label>
      </div>
