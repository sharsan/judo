...
<body>
  ...
  @endif
  <form method="post" action="{{action('CouchClubeController@update', $id)}}"> 
    {{csrf_field()}}
    ...
    <div class="col-md-4">
     <label for="treinador_id"> Nome do treinador:</label>
     <input type="text" class="form-control" name="treinador_id"placeholder="Ex: Chiquinho Conde"value="{{$treinador->nome}}">
   </input>
 ...
 <div class="col-md-4">
  ...
  <input type="text" class="form-control" name="clube_id" placeholder="Ex: Costa do Sol" value="{{$treinador->clube}}">
</input>
